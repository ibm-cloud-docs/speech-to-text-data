...
Hesitation markers can appear in both interim and final results. However, enabling smart formatting prevents hesitation markers from appearing in final results. For more information, see [Smart formatting](/docs/speech-to-text-data?topic=speech-to-text-data-output#smart_formatting).
{: note}
