...
-   [Create a custom acoustic model](/docs/services/speech-to-text-data?topic=speech-to-text-data-acoustic#createModel-acoustic)
-   [Train the custom acoustic model](/docs/services/speech-to-text-data?topic=speech-to-text-data-acoustic#trainModel-acoustic)
