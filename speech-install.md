...
# Installing the {{site.data.keyword.watson}} {{site.data.keyword.speechtotextshort}} add-on
{: #stt-installing}

You can install the {{site.data.keyword.speechtotextdatafull}} add-on on top of {{site.data.keyword.icp4dfull}}, with or without Red Hat OpenShift.
{: shortdesc}
