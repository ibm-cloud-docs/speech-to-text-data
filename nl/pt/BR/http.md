...
Para obter mais informações sobre os parâmetros de consulta, consulte o [Resumo de parâmetro](/docs/services/speech-to-text-data?topic=speech-to-text-data-summary).
