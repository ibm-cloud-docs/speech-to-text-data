...
Para obtener más información acerca de los parámetros de consulta, consulte el [Resumen de parámetros](/docs/services/speech-to-text-data?topic=speech-to-text-data-summary).
