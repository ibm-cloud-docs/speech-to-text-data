...
Pour plus d'informations sur les paramètres de requête, voir [Récapitulatif des paramètres](/docs/services/speech-to-text-data?topic=speech-to-text-data-summary).
